...
class JobOffer(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    company = db.Column(db.Integer, db.ForeignKey('CompanyProfile.id'), nullable=False)
...
class JobRequest(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    company = db.Column(db.Integer, db.ForeignKey('job_offer.id'), nullable=False)
    jobseeker = db.Column(db.Integer, db.ForeignKey('job_seeker.id'), nullable=False)
